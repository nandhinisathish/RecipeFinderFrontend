  ...
  async function signUp(formData) {
    ...
    console.log("Response data:", res.data);   // Debug log
      ...
      if (res.status === 201 && res.data.token) {
        ...
        toast.success(
          `User with email ${formData.email} registered successfully 🎉`,
    ...
    try {
      ...
      if (res.status === 200 && res.data.token && res.statusText === "OK") {
        ...
        toast.error("Invalid credentials..", {
          toastId: "err-Invalid-Crendentials-entered",
        });
      ...
      toast.error("Invalid credentials", {
        toastId: "err-Invalid-Crendentials",
      });
